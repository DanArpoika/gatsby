...
async function fetch({
  ...
  if (_verbose) console.log(``); // Call the main API Route to discover the all the routes exposed on this API.
...
cvdfhd
  if (_useACF) {
    ...
    _acfOptions.forEach(function(acfOptionRoute) {
      validRoutes.push({
        url: `${url}/acf/v${acfVersion}/options/${acfOptionRoute}`,
